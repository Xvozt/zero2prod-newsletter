...
#[tokio::test]
async fn subscribe_should_return_400_for_some_form_data_missing() {
    // Arrange
    let app = spawn_app().await;
    let test_cases = vec![
...
#[tokio::test]
async fn subscribe_should_return_400_when_fields_are_present_but_empty() {
    // Arrange
    let app = spawn_app().await;
    let test_cases = vec![
...
#[tokio::test]
async fn subscribe_should_send_a_confirmation_mail_with_a_link() {
    // Arrange
    let app = spawn_app().await;
    let body = "name=le%20guin&email=ursula_le_guin%40gmail.com";
...
#[tokio::test]
async fn subscribe_fails_if_there_is_a_fatal_error_on_database() {
    let app = spawn_app().await;
    let body = "name=le%20guin&email=ursula_le_guin%40gmail.com";
